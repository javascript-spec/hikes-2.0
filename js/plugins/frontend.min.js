...
!(function () {
  ...
  function m(e) {
    var t = "";
    if (
      null == (u = i.querySelector("#ast-mobile-header")) ||
      "dropdown" !== u.dataset.type ||
      "updateHeader" === e
    ) {
      t = (
  ...
  function n(e) {
    ...
    if ("off-canvas" === e) {
      var s = document.getElementById("menu-toggle-close"),
        n = document.querySelector(".ast-mobile-popup-inner");
      if (null == n) return;
      popupLinks = n.getElementsByTagName("a");
      ...
      for (
        s.addEventListener("click", function (e) {
          ...
          link = 0,
          len = popupLinks.length;
        link < len;
        link++
      )
        null === popupLinks[link].getAttribute("href") ||
          "#" != popupLinks[link].getAttribute("href") ||
          popupLinks[link].parentElement.classList.contains(
            "menu-item-has-children"
          ) ||
          (popupLinks[link].addEventListener("click", g, !0),
          (popupLinks[link].headerType = "off-canvas"));
      AstraToggleSetup();
    } else if ("dropdown" === e) {
      (s = document.querySelector(".ast-mobile-header-content") || !1),
        (e = document.querySelector(".ast-desktop-header-content") || !1);
      if (s) {
        ...
        for (link = 0, len = l.length; link < len; link++)
          null === l[link].getAttribute("href") ||
            ...
            (l[link].addEventListener("click", g, !0),
  ...
  "" !== (u = null != i ? i.querySelector("#ast-mobile-header") : u) &&
    null !== u &&
    (c = u.dataset.type),
                ...
                if (void 0 !== a) {
                  ...
                  for (o = 0, l = n.length; o < l; o++)
                    n[o].addEventListener("focus", b, !0),
                      ...
                      n[o].addEventListener("click", y, !0);
    ...
    (astraNavMenuToggle = function (e) {
      if ("undefined" != typeof astraAddon)
        ...
        if (
          ...
          return !1;
        for (
          var a = t[e].querySelectorAll(".menu-item-has-children"), n = 0;
          n < a.length;
          n++
        ) {
          a[n].classList.remove("ast-submenu-expanded");
        ...
        -1 !==
          ...
          (astraToggleClass(t[e], "toggle-on"),
          astraToggleClass(l[e], "toggled"),
          t[e].classList.contains("toggle-on")
  ...
  (a = navigator.userAgent),
    ...
    /trident/i.test(v[1])
      ? (t = /\brv[ :]+(\d+)/g.exec(a) || [])
      : ("Chrome" === v[1] && null != (t = a.match(/\bOPR|Edge\/(\d+)/))) ||
        ((v = v[2]
          ? [v[1], v[2]]
          : [navigator.appName, navigator.appVersion, "-?"]),
        null != (t = a.match(/version\/(\d+)/i)) && v.splice(1, 1, t[1]),
        "Safari" === v[0] &&
          v[1] < 11 &&
          bodyElement.classList.add("ast-safari-browser-less-than-11"));
  for (
    var h = document.getElementsByClassName("astra-search-icon"), f = 0;
    f < h.length;
    f++
  )
